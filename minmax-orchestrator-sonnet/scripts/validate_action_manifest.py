...
ACTION_CLASSES={"read_only","reversible_write","external_write","irreversible_high_consequence"}; AUTONOMY_MODES={"supervised","autonomous"}; VERIFY_METHODS={"authoritative_read","deterministic_test","transaction_receipt"}; COMPENSATION={"rollback","inverse_action","follow_up","not_possible"}
def present(v):
