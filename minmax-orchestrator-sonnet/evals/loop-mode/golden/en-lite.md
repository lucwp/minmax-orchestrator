...
**Planning:** hierarchical_adaptive; observability=partial; adaptation=change only the next local action from verified cycle evidence while frozen boundaries remain valid
