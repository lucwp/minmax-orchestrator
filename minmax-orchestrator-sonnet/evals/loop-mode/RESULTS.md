...
- planning-regime / observability / feedback-provenance hard gates for schema `1.5`;
- incremental evidence-ledger and changed-strategy iteration policy;

- latest-schema default (`1.5`) with explicit legacy resume/migration path only;
